...
#NOTES:-
#we ca also use implicit wait https://selenium-python.readthedocs.io/waits.html 


#initialize webdriver
driver=webdriver.Chrome(r'C:\Users\HP\Documents\Website Automation\chromedriver.exe')
...
#save screenshot
driver.save_screenshot('screenshot#' + str(random.randint(0,51)) + '.png')
